<?php
  ...
  *******************************************************************/
  ...
  $uViews = array(
    ...
    "company"     => array("title" => "Company", "location" => "company.html", "parent" => ""),
      "company/about"       => array("title" => "About Us", "location" => "about.html", "parent" => "company"),
      "company/help"        => array("title" => "Help", "location" => "help.html", "parent" => "company"),
      "company/terms"       => array("title" => "Terms", "location" => "terms.html", "parent" => "company"),
      "company/contact"     => array("title" => "Contact Us", "location" => "contact.html", "parent" => "company"),
    "uploads"     => array("title" => "Uploads", "location" => "uploads.html", "parent" => ""),
    "404"         => array("title" => "404 Error -- File Not Found", "location" => "404.html", "parent" => "")
  ...
  $oViews = array(
    ...
    "home"        => array("title" => "Welcome Home", "location" => "home.html", "parent" => ""),
      "register"    => array("title" => "Registration Page", "location" => "auth/register.html", "parent" => "home"),
    "activate"    => array("title" => "Activate Your Account", "location" => "auth/activate.html", "parent" => ""),
    "change-pass" => array("title" => "Change Your Password", "location" => "auth/forgot.html", "parent" => ""),
    "login"       => array("title" => "Login Page", "location" => "auth/login.html", "parent" => "")
  ...
  $iViews = array(
    ...
    "dashboard"   => array("title" => "Dashboard", "location" => "user/dashboard.html", "parent" => ""),
    "settings"    => array("title" => "Account Settings", "location" => "user/settings.html", "parent" => "dashboard"),
    "profile"     => array("title" => "Profile", "location" => "user/profile.html", "parent" => "dashboard"),
    ...
    elseif(isset($iViews[$view])) {
      ...
      */
      ...
      if($flag === 1) {
        ...
        $flag = 2;
        if($is404 == "yes") { $viewLoc = "/404"; } 
        elseif($is404 == "no") { $viewLoc = "/"; }
      } 
      elseif($flag === 0) {
          if(isset($_SESSION['id'])) {
              if($is404 == "yes") {
